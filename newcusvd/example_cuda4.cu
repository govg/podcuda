...
* Small update for test on CUDA 4.0 (GTX 580)                                                   * 
************************************************************************************************/
...
int main(int argc, char** argv)
{
	...
	cublasAlloc(M*N*sizeof(float), sizeof(float), (void**)&d_A);
	cublasAlloc(M*M*sizeof(float), sizeof(float), (void**)&d_U);	
	cublasAlloc(N*N*sizeof(float), sizeof(float), (void**)&d_VT);
	...
	cublasSetMatrix(M, N, sizeof(float),  U, M,  d_U, M);
	cublasSetMatrix(M, N, sizeof(float), VT, M, d_VT, M);
